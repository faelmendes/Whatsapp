...
String help = "\t============= help =====================\n"+
					  ...
					  "\\users:_nomeGrupo_: ver usuarios do grupo \n"+
                                           "\\leave:_nome_nomedoGrupo_: apagar usuario do grupo \n"+
                                           "\\invite:_nome_nomeNovo_nomedoGrupo_: cadatra o usuario no grupo que esta o _nome_      \n"+
					  "\tend: sai do programa\n"+
					  "\t========================================\n";
         ...
         if(comando.equals("help")){
                ...
                switch(c[0]){
                            case "zap":
                                      ...
                                      String menssagem = "";
                                      menssagem += c1;
                                      zap.conversaGrupo(c[1], c[2],menssagem);
                            ...
                            case "newchat":
                                    ...
                                    break;
                             case "chats":
                                         System.out.println(zap.ChatGrupos(c[1]));
